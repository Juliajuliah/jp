...
const Kontakt = ({ data }) => (
  <Fragment>
    <Content>
      ...
      <P>
        <br />{' '}
        <A blank={false} href="mailto:j.h.c.n.reimann@googlemail.com">
          {' '}
        </A>
        <br />
        j.h.c.n.reimann[at]googlemail.com<br />
        IG<br />
      </P>
      <P>
        Umsatzsteueridentifikationsnummer XXXXX<br />
        Steuernummer XXXXX Berlin – Neukölln
      </P>
      <P>Impressum</P>
      ...
      <P>
        Kontakt: <br />
        Telefon: 017632665780<br />
        E-Mail: j.h.c.n.reimann@googlemail.com<br />
      </P>
      <P>
        Umsatzsteuer-ID: <br />
        Umsatzsteuer ID DE176144384<br />
        Steuernummer 18/444/00112 Finanzamt Berlin Schöneberg <br />
